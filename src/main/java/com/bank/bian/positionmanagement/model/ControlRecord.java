package com.bank.bian.positionmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Market Position Management Plan".
 *
 ...
 * to its asset type (Market Position). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Market Position Management Plan";
